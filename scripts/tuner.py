...
# Generates a temporary shell script to inject ENV vars
...
# Spawns two bot instances and battles them via engine
...
# Threads multiple match evaluations in parallel
...
# Coordinate-descent global loop (loops parameters 1x1, keeps winners)
def main():
